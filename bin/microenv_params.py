...
class MicroenvTab(object):
    ...
    def __init__(self):
        ...
        menv_var1 = Button(description='virus (particles/micron^3)', disabled=True, layout=name_button_layout)
        ...
        self.virus_diffusion_coefficient = FloatText(value=1000,
        ...
        self.virus_decay_rate = FloatText(value=0,
        ...
        menv_units_button3 = Button(description='particles/micron^3', disabled=True, layout=units_button_layout) 
        menv_units_button4 = Button(description='particles/micron^3', disabled=True, layout=units_button_layout) 
